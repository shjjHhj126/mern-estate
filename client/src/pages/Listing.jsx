        ...
        <div>
          ...
          <div className="">
            <FaShare
              ...
              onClick={() => {
                navigator.clipboard.writeText(window.location.href); // copy the current URL (window.location.href) to the clipboard
                setCopied(true);
                setTimeout(() => {
                  setCopied(false), 2000;
                }); // set copied to false after 2s
              }}
            />
          </div>
          {copied && <p className="">Link copied!</p>}
